      ...
      <div id='registeruser-page-content'>
        <div id='registeruser-form'>
          ...
          <p id='already-have-account'>
            ...
            <Link id='registeruser-already-account' to='/login'>
              Sign in
            </Link>
          </p>
    ...
    return (
      <div id='registeruser-page-content'>
        ...
        <div id='await-confirm'>
          ...
          <p>
            Please <b>check your inbox</b> for a confirmation email that will
            allow you to continue logging in. After clicking the{' '}
            <b>confirmation link</b>, click{' '}
            <span id='continue-btn-small'>Continue</span>.
          </p>
